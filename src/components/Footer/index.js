    ...
    return <> 
        ...
        <div className="footer-container">
            <div className="footer-social">
                <ul>
                    <li><a href="https://twitter.com/clit_opia" rel="noreferrer" target="_blank"><FontAwesomeIcon icon={faTwitter} className="icon" /></a></li>
                    <li><a href="https://discord.com/clitopia" rel="noreferrer" target="_blank"><FontAwesomeIcon icon={faDiscord} className="icon" /></a></li>
